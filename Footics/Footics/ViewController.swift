...
//    }
    ...
    @IBOutlet var premierLogo: UIButton!
    @IBOutlet var laligaLogo: UIButton!
    @IBOutlet var seriaLogo: UIButton!
    @IBOutlet var BundesLogo: UIButton!
    @IBOutlet var league1Logo: UIButton!
